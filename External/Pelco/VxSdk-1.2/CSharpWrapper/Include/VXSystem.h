...
namespace CPPCli {
    ...
    public:
        ...
        System::Collections::Generic::List<DataSource^>^ GetDataSources(System::String^ id);
        ...
        System::Collections::Generic::List<Device^>^ GetDevices(System::String^ id);
        ...
        System::Collections::Generic::List<Situation^>^ GetSituations(System::String^ type, System::String^ deviceId);
