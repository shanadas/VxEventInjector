...
{
    /// <summary>
    /// A standard button with additional properties that will be used in the template.
    /// This way we can have one template for all of our buttons and just use properties to change the style.
    /// </summary>
